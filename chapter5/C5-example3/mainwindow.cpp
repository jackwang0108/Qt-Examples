    ...
    : QMainWindow(parent), ui(new Ui::MainWindow)
{
    ...
    ui->tableView->setItemDelegateForColumn(0, intSpinboxDelegate);

    floatSpinboxDelegate = new TFloatSpinboxDelegate(this);
    ui->tableView->setItemDelegateForColumn(1, floatSpinboxDelegate);
    ui->tableView->setItemDelegateForColumn(2, floatSpinboxDelegate);
    ui->tableView->setItemDelegateForColumn(3, floatSpinboxDelegate);

    comboBoxDelegate = new TComboBoxDelegate(this);
    QStringList strList{"优", "良", "中", "差"};
    comboBoxDelegate->setItem(strList, false);
